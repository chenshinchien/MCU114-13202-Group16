...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cities = arrayOf("Taipei","New Taipei","Taoyuan","Hsinchu","Miaoli","Taichung","Changhua","Nantou","Yunlin","Chiayi","Tainan","Kaohsiung","Pingtung","Yilan","Hualien","Taitung","Keelung","Penghu","Jingmen","Lianjiang")
    ...
    private fun fetchWeather(cityName : String) {
        ...
        val apiKey = "08484c0a36c02227e5559ae37fa34f7d"
